...
class LinearSystem(object):
    ...
    def compute_solution(self):
        try:
            return self.do_gaussian_elimnation_and_parametrize_solution()
    ...
    def do_gaussian_elimnation_and_parametrize_solution(self):
        rref = self.compute_rref()

        rref.raise_exception_if_contradictory_equation()

        direction_vector = rref.extract_direction_vectors_for_parametrization()
        basepoint = rref.extract_basepoint_for_parametrization()

        return Parametrization(basepoint, direction_vector)
    ...
    def do_gaussian_elimnation_and_extract_solution(self):
        rref = self.compute_rref()
    ...
    #将 row_to_add 行乘以系数 coefficient 加到 row_to_be_added_to ， row_to_add 行不变
...
# s.do_gaussian_elimnation_and_extract_solution()
r = s.compute_rref()
